...
public class StaffScheduleController {
  ...
  public ResponseEntity<BaseResponse<StaffTimeOffResponse>> requestTimeOff(
      @AuthenticationPrincipal GatewayUserPrincipal staff,
  ...
  public ResponseEntity<BaseResponse<List<StaffTimeOffResponse>>> pending(
    ...
    return ResponseEntity.ok(
        BaseResponse.success("대기중 휴무 요청 조회", staffScheduleService.listPendingRequests(storeId))
    );
  }
  ...
  public ResponseEntity<BaseResponse<List<StaffTimeOffResponse>>> approved(
    ...
    return ResponseEntity.ok(
        BaseResponse.success("승인된 휴무 요청 조회", staffScheduleService.listApprovedRequests(storeId))
    );
  }
  ...
  public ResponseEntity<BaseResponse<List<StaffTimeOffResponse>>> rejected(
    ...
    return ResponseEntity.ok(
        BaseResponse.success("거절된 휴무 요청 조회", staffScheduleService.listRejectedRequests(storeId))
    );
  }
