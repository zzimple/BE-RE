...
import com.zzimple.auth.dto.request.UpdateEmailRequest;
import com.zzimple.auth.dto.request.UpdatePasswordRequest;
...
import com.zzimple.auth.service.UserService;
...
public class UserController {
  ...
  @GetMapping("/profile")
  public ProfileResponse profile(@AuthenticationPrincipal GatewayUserPrincipal user) {
    Long userId = user.getUserId();
